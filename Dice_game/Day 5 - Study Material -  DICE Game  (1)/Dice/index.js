...
image2.setAttribute("src", randomImageSource4);


// Main Logic of Dice

let largest = Math.max(randomNum1, randomNum2, randomNum3, randomNum4);
if (largest == randomNum1) {
    if (randomNum2 === randomNum1 || randomNum3 === randomNum1 || randomNum4 === randomNum1) {
        document.querySelector("h1").innerHTML = "Draw!";
    } else {
        document.querySelector("h1").innerHTML = "Player 1 Wins!";
    }
} else if (largest == randomNum2) {
    if (randomNum1 === randomNum2 || randomNum3 === randomNum2 || randomNum4 === randomNum2) {
        document.querySelector("h1").innerHTML = "Draw!";
    } else {
        document.querySelector("h1").innerHTML = "Player 2 Wins!";
    }
} else if (largest == randomNum3) {
    if (randomNum1 === randomNum3 || randomNum2 === randomNum3 || randomNum4 === randomNum3) {
        document.querySelector("h1").innerHTML = "Draw!";
    } else {
        document.querySelector("h1").innerHTML = "Player 3 Wins!";
    }
} else if (largest == randomNum4) {
    if (randomNum1 === randomNum4 || randomNum2 === randomNum4 || randomNum3 === randomNum4) {
        document.querySelector("h1").innerHTML = "Draw!";
    } else {
